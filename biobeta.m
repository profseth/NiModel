function [A,b,output] = biobeta(A,b,do)

%BIOBETA sets biological uptake and remineralization
%   martinb is the Martin 'b-value'; beta is the relative rate constant
%   for uptake of element E compared to uptake of P, similar to
...
beta = do.biobeta.beta;
martinb = do.biobeta.martinb;
sedremin = do.biobeta.sedremin;
...
% multiplied by the PFD (fraction of that productivity with remineralizations),
